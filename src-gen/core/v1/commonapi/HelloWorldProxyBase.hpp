...
public:
    typedef CommonAPI::ObservableReadonlyAttribute< bool> HelloStateAttribute;
    ...
    virtual HelloStateAttribute& getHelloStateAttribute() = 0;

    virtual HelloBroadcastEvent& getHelloBroadcastEvent() = 0;
