...
public:
    ...
    COMMONAPI_EXPORT virtual const bool& getHelloStateAttribute();
    COMMONAPI_EXPORT virtual const bool& getHelloStateAttribute(const std::shared_ptr<CommonAPI::ClientId> _client);
    COMMONAPI_EXPORT virtual void setHelloStateAttribute(bool _value);
    ...
    COMMONAPI_EXPORT virtual void fireHelloBroadcastEvent(const std::string &_message);

    
protected:
    COMMONAPI_EXPORT virtual bool trySetHelloStateAttribute(bool _value);
    COMMONAPI_EXPORT virtual bool validateHelloStateAttributeRequestedValue(const bool &_value);
...
private:
    ...
    bool helloStateAttributeValue_ {};
