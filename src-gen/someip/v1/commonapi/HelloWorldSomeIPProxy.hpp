...
private:
    ...
    CommonAPI::SomeIP::ObservableAttribute<CommonAPI::SomeIP::ReadonlyAttribute<HelloStateAttribute>> helloState_;

     CommonAPI::SomeIP::Event<HelloBroadcastEvent, CommonAPI::Deployable< std::string, CommonAPI::SomeIP::StringDeployment >> helloBroadcast_;
