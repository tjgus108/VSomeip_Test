...
public:
    ...
    void fireHelloStateAttributeChanged(const bool& value);

    void fireHelloBroadcastEvent(const std::string& message);
            ...
            std::dynamic_pointer_cast< HelloWorldStub>(_stub))
    {
        ...
        // Provided events/fields
        {
            ...
            CommonAPI::SomeIP::StubAdapter::registerEvent(CommonAPI::SomeIP::event_id_t(0x8235), itsEventGroups, false);
        }
        {
            std::set<CommonAPI::SomeIP::eventgroup_id_t> itsEventGroups;
            itsEventGroups.insert(CommonAPI::SomeIP::eventgroup_id_t(CommonAPI::SomeIP::eventgroup_id_t(0x1001)));
            CommonAPI::SomeIP::StubAdapter::registerEvent(CommonAPI::SomeIP::event_id_t(0xa005), itsEventGroups, true);
            fireHelloStateAttributeChanged(std::dynamic_pointer_cast< ::v1::commonapi::HelloWorldStub>(_stub)->getHelloStateAttribute(clientId));
        }
...
CommonAPI::SomeIP::GetAttributeStubDispatcher<
    ::v1::commonapi::HelloWorldStub,
    bool
> HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::getHelloStateAttributeStubDispatcher(
    &HelloWorldStub::lockHelloStateAttribute,
    &HelloWorldStub::getHelloStateAttribute, false);
...
template <typename _Stub, typename... _Stubs>
void HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::fireHelloStateAttributeChanged(const bool& value) {
