...
,          helloState_(*this, CommonAPI::SomeIP::eventgroup_id_t(0x1001), CommonAPI::SomeIP::event_id_t(0xa005), CommonAPI::SomeIP::method_id_t(0x2007), false, false, static_cast< CommonAPI::EmptyDeployment* >(nullptr))
,          helloBroadcast_(*this, 0x1002, CommonAPI::SomeIP::event_id_t(0x8235), false, false, std::make_tuple(static_cast< CommonAPI::SomeIP::StringDeployment* >(nullptr)))
    {
    }

    HelloWorldSomeIPProxy::HelloStateAttribute& HelloWorldSomeIPProxy::getHelloStateAttribute() {
        return helloState_;
    }

    HelloWorldSomeIPProxy::HelloBroadcastEvent& HelloWorldSomeIPProxy::getHelloBroadcastEvent() {
        return helloBroadcast_;
    }
